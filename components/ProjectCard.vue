...
const { image, tag, title, preview, stack, url, git } = defineProps<ProfileCardProps>();
	...
	<div
	  ...
	  >
		...
		<div class="flex items-center px-6 py-3 bg-gray-900">
		  ...
		  <h1 class="mx-3 text-lg font-semibold text-white">{{ tag }}</h1>
		</div>
		...
		<div class="px-6 py-4">
		  ...
		  <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
			...
			<h1 class="px-2 text-sm">{{ stack.Backend }}</h1>
		  </div>
		  ...
		  <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
			...
			<h1 class="px-2 text-sm">{{ stack.Frontend }}</h1>
		  </div>
		  ...
		  <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
			...
			<a :href="url" class="px-2 text-sm">{{ url }}</a>
		  </div>
		  <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
			...
			<a :href="git" class="px-2 text-sm">{{ git }}</a>
		  </div>
		</div>
	  </div>
</template>